...
const DigitalBackground = () => {
  ...
  return (
    <>
      <motion.div
        className="ease-out duration-150 absolute bg-[url('/components/digitalbackground/agents-bg-2.webp')] bottom-0 z-0
      ...
      />
      <div
        className="absolute right-0 bg-no-repeat top-[10%] w-8 h-[32.5rem] bg-[url('/components/digitalbackground/bg-sprite.webp')]"
